...
const Footer = () => {
  return (
    <div id="Footer">
        <div className='MainChildDivFooter'>
            <div className='AboveSecFooter'>
            <div className="EachDivInRow">
                <h3>
                    LOCATION
                </h3>
                <div>
...
Clark, MO 65243
            ...
            <div className='AllSvgDivMain'>
            <a href='#' className="eachsvgdiv">
